      ...
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          <Link to="/" className="inline-flex flex-col items-center gap-2.5">
            <span className="font-heading text-2xl tracking-[0.35em] text-foreground">THE AVIATOR</span>
            <span className="flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.3em] text-muted-foreground">
              <span className="inline-block h-1.5 w-1.5 bg-[#C7D400]" />
              {"·"}
        ...
        <div className="relative overflow-hidden border border-border bg-background">
          <span className="absolute left-0 top-0 h-[3px] w-full bg-[#C7D400]" />
          <div className="p-6 sm:p-8">
            <div className="flex items-center gap-3.5">
              <span className="flex h-11 w-11 shrink-0 items-center justify-center bg-navy text-[#C7D400]">
                <Icon className="h-5 w-5" aria-hidden="true" />
              </span>
              <div>
                <h1 className="font-heading text-2xl leading-tight text-foreground">{title}</h1>
