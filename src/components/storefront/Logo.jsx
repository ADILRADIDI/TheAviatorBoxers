  ...
  return (
    <span className={cn("inline-flex flex-col items-center leading-none", className)}>
      ...
      <span className="mt-1.5 flex flex-col items-center">
        ...
        <span className={cn("font-heading text-[17px] font-bold uppercase tracking-[0.2em]", isLight ? "text-white" : "text-navy")}>Aviator</span>
      </span>
    </span>
  );
}
  ...
  return (
    <span className={cn("inline-flex items-center gap-2.5", className)}>
      ...
      <span className="flex flex-col leading-none">
        ...
        <span className={cn("mt-1 font-heading text-[13px] font-bold uppercase tracking-[0.18em]", isLight ? "text-white" : "text-navy")}>
          The Aviator
        </span>
      </span>
    </span>
