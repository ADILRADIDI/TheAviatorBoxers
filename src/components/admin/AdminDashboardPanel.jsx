...
import { ArrowUpRight, Boxes, CheckCircle2, ClipboardList, Clock, Compass, Package, ShoppingCart, TrendingUp, Truck, Users } from "lucide-react";
...
const statusFlow = [
  ...
  { key: "livree", label: "Livrée", icon: CheckCircle2, color: "bg-[#C7D400]" },
];

export default function AdminDashboardPanel({ data = {}, onNavigate = () => {}, period = "all", onPeriodChange = () => {} }) {
  const quickActions = [
    ["acquisition", "Sources de trafic & Pubs", Compass],
    ["commandes", "Voir les commandes", ClipboardList],
    ["produits", "Catalogue produits", Package],
    ...
    <div className="space-y-6">
      ...
      <section className="admin-pop relative overflow-hidden rounded-2xl bg-[linear-gradient(120deg,#00285E_0%,#001A3E_55%,#000_100%)] px-6 py-8 text-white sm:px-8">
        ...
        <div className="relative z-10 flex flex-wrap items-center justify-between gap-6">
          <div className="max-w-xl">
            ...
            <h2 className="mt-2 font-heading text-3xl font-black tracking-tight sm:text-4xl">Tableau de bord</h2>
              ...
              {(data.topProducts || []).map((product, index) => {
                ...
                return (
                  <div key={`${product.product_id}-${index}`} className="grid grid-cols-[auto_1fr_auto] items-center gap-4 py-3">
                    <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-md bg-navy font-heading text-xs font-black text-accent-lime">{index + 1}</span>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <article className="admin-card admin-pop p-5">
          ...
          <strong className="mt-3 block font-heading text-2xl font-black text-navy">{formatNumber(data.averageOrder)} DH</strong>
        ...
        <article className="admin-card admin-pop p-5">
          ...
          <strong className="mt-3 block font-heading text-2xl font-black text-navy">{data.pendingReviews || 0}</strong>
        ...
        <article className="admin-card admin-pop p-5">
          ...
          <div className="mt-3 flex items-center gap-2">
            ...
            <strong className="font-heading text-2xl font-black text-navy">Opérationnel</strong>
          </div>
