    ...
    return (
        <div className="storefront-app flex min-h-screen items-center justify-center bg-ink p-6 text-white">
            <div className="max-w-lg w-full text-center">
                <p className="text-[11px] font-semibold uppercase tracking-[0.25em] text-[#C7D400]">Error 404</p>
                <h1 className="mt-6 font-heading text-[clamp(5rem,20vw,9rem)] leading-none text-white/15 select-none">404</h1>
                <span className="mx-auto block h-1 w-14 bg-[#C7D400]" />
                <h2 className="mt-8 font-heading text-2xl sm:text-3xl">{t("Cette page n'existe pas.")}</h2>
