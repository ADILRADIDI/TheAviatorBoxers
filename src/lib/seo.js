...
export const FALLBACK_DESCRIPTION =
  "THE AVIATOR — Boxers premium pour hommes au Maroc. 95% coton, 5% Élasthanne, confort et maintien. Paiement à la livraison, livraison 24-48h partout au Maroc.";
...
export function websiteJsonLd() {
  return {
    ...
    name: "The Aviator",
    url: SITE_URL,
    description: "Boxers premium pour hommes au Maroc — coton et Élasthanne. Paiement à la livraison partout au Maroc.",
    inLanguage: ["fr-MA", "ar-MA"],
    potentialAction: {
      "@type": "SearchAction",
      target: `${SITE_URL}/notre-boxer?q={search_term_string}`,
    ...
    "@graph": [
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "Notre Boxer", item: `${SITE_URL}/notre-boxer` },
