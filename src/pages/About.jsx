...
export default function About() {
  ...
  return (
    <>
      <AnnouncementBar />
      <PageHeader eyebrow="Notre histoire" title="À propos" subtitle="Une marque marocaine née de la passion du confort et du style." />
      ...
      <section className="py-16 lg:py-24">
        <div className="container-edge grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <span className="label-eyebrow">La marque</span>
            <h2 className="mt-2 font-display text-3xl font-bold tracking-tight sm:text-4xl">La précision au service du confort</h2>
            <div className="mt-5 space-y-4 text-sm leading-relaxed text-muted-foreground sm:text-base">
              <p>
                The Aviator est une marque marocaine de sous-vêtements premium pour hommes.
                Née de la conviction que le confort mérite la même exigence que le style,
                nous réunissons des tissus haut de gamme et un savoir-faire rigoureux.
              </p>
              <p>
                Inspirés par l'élégance technique de l'aéronautique, nous concevons chaque pièce
                comme un équipement de précision : maintien parfait, liberté de mouvement
                et confort durable, dans un style affirmé.
              </p>
              <p>
                Notre mission est simple : offrir à l'homme marocain moderne des sous-vêtements
                qu'il soit fier de porter, et qui le accompagnent dans toutes les situations
                de la journée.
              </p>
            </div>
          </div>
      ...
      <section className="bg-secondary py-16 lg:py-24">
        <div className="container-edge">
          <Reveal className="text-center">
            <span className="label-eyebrow">Nos valeurs</span>
            <h2 className="mt-2 font-display text-3xl font-bold tracking-tight sm:text-4xl">Ce qui nous guide</h2>
          </Reveal>
