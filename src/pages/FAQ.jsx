...
const FAQS = [
  ...
  { cat: "Paiement", q: "Le paiement en ligne est-il disponible ?", a: "Le paiement en ligne sera bientôt disponible. En attendant, le paiement à la livraison est disponible partout au Maroc." },
...
export default function FAQ() {
  ...
  return (
    <>
      <AnnouncementBar />
      <PageHeader eyebrow="Aide" title="Questions fréquentes" subtitle="Tout ce que vous devez savoir sur nos produits et services." />
      ...
      <div className="container-edge py-12 lg:py-16">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-10 border border-border bg-secondary p-8 text-center">
            <h3 className="font-display text-xl font-bold">Vous ne trouvez pas votre réponse ?</h3>
            <p className="mt-2 text-sm text-muted-foreground">Notre équipe est à votre disposition.</p>
            <Link to="/contact" className="mt-5 inline-block bg-navy px-6 py-3 text-xs font-bold uppercase tracking-[0.15em] text-white">Nous contacter</Link>
          </div>
        </div>
      </div>
    </>
