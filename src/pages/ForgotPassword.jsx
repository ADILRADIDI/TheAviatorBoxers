...
export default function ForgotPassword() {
  ...
  return (
    <AuthLayout
      ...
      footer={
        <Link to="/login" className="inline-flex items-center gap-1.5 font-semibold text-foreground underline underline-offset-4 hover:text-[#C7D400]">
          <ArrowLeft className="h-3 w-3" />Back to log in
        </Link>
      }
    >
      {sent ? (
        <div className="border border-[#C7D400]/30 bg-[#C7D400]/10 px-4 py-4 text-center text-sm text-ink">
          <span className="mx-auto mb-2 block h-1.5 w-8 bg-[#C7D400]" />
