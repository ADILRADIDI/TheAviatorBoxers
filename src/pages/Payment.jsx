  ...
  return (
    <>
      <PageHeader
        ...
        title={t("Paiement")}
        subtitle={t("Des options de paiement simples et fiables.")}
        image="/images/boxer-stack.jpg"
      />
          ...
          <Reveal>
            <div className="border border-border bg-background p-6 lg:p-8">
              <div className="flex items-center gap-4">
                <div className="flex h-14 w-14 items-center justify-center bg-[#C7D400]/15 text-ink">
                  <Banknote className="h-7 w-7" />
                </div>
                <div>
                  <h2 className="font-heading text-xl font-bold">{t("Paiement à la livraison (COD)")}</h2>
