    ...
    return (
      ...
      >
        ...
        <div className="flex justify-center gap-2" role="group" aria-label="Verification code">
          {Array.from({ length: 6 }).map((_, index) => (
            <input
              ...
              className="h-14 w-11 border-b-2 border-border bg-transparent text-center font-heading text-xl text-ink focus:border-b-[#C7D400] focus:outline-none"
            />
          ))}
        </div>
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground">
          ...
          <button type="button" onClick={handleResend} className="font-semibold text-foreground underline underline-offset-4 hover:text-[#C7D400]">
            Resend
          </button>
        </p>
      </AuthLayout>
