        ...
        <div className="mx-auto max-w-xl">
            ...
            <section className="mt-8 border border-border bg-background p-6" aria-live="polite">
              <div className="flex items-center gap-3 border-b border-border pb-4">
                ...
                <div>
                  ...
                  <h2 className="font-heading text-xl font-bold">#{order.order_number || order.id}</h2>
                </div>
              </div>
          ...
          {order?.return_request ? (
            <section className="mt-8 border border-border bg-secondary p-6">
              <h2 className="font-heading text-xl font-bold">{t("Retour")}</h2>
            ...
            <form onSubmit={submitReturn} className="mt-8 border border-border bg-secondary p-6">
              <h2 className="font-heading text-xl font-bold">{t("Demander un retour")}</h2>
          ...
          <Link to="/notre-boxer" className="mt-6 block text-center text-xs font-medium uppercase tracking-wider text-muted-foreground underline underline-offset-4">{t("Continuer mes achats")}</Link>
        </div>
      </main>
    </>
  );
